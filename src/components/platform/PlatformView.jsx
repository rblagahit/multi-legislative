    ...
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8">
        ...
        {isActiveTabReady && activeTab === 'overview' ? (
          <PlatformOverviewTab
            featureRequestLimit={FEATURE_REQUEST_LIMIT}
            overviewLguSampleLimit={OVERVIEW_LGU_SAMPLE_LIMIT}
            pendingRequestGroups={pendingRequestGroups}
            pendingUsers={pendingUsers}
            registryMap={registryMap}
            roleChartItems={roleChartItems}
            tierChartItems={tierChartItems}
          />
        ) : null}
